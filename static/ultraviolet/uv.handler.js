(() => {
	...
	function y(o) {
		...
		if (
			...
			a.nativeMethods.defineProperty(
				...
				"__uv$storageObj",
				{
					get() {
						...
						if (this === a.storage.localStorage)
			...
			for (let t in o.localStorage)
				t.startsWith(s + e.location.origin + "@") &&
					(e.localStorageObj[
						t.slice((s + e.location.origin + "@").length)
		...
		a.nativeMethods.defineProperty(e.meta, "base", {
			...
			a.message.on("postMessage", (t) => {
				...
				t.that && (i = t.that.__uv$source.call),
					...
					(t.data.message = {
						__data: t.data.message,
						__origin: (t.that || t.target).__uv$source.location
							.origin,
						__to: r,
					}),
					t.respondWith(
						E
							? i(
									t.target,
									[t.data.message, t.data.transfer],
									t.that,
								)
							: i(
									t.target,
			...
			a.element.on("setAttribute", (t) => {
				...
				e.attrs.isUrl(t.data.name) &&
					...
					e.attrs.isSrcset(t.data.name) &&
						...
						(t.data.value = e.html.wrapSrcset(
		...
		let I =
			d &&
			Object.getOwnPropertyDescriptor(d.prototype, "contentWindow").get;
		function v(t) {
			let r = I.call(t);
			if (!r.__uv)
				try {
			...
			a.document.on("setDomain", (t) => {
				if (
					!t.data.value
						.toString()
						.endsWith(
							e.meta.url.hostname.split(".").slice(-2).join("."),
						)
				)
		...
		function h(t, r) {
			...
			Reflect.defineProperty(t, i, {
				...
				set(n) {
					typeof n == "function" &&
						(l.has(this) &&
							this.removeEventListener(r, l.get(this)),
						l.set(this, n),
			...
			for (let t of a.style.urlProps)
				a.overrideDescriptor(o.CSS2Properties.prototype, t, {
					...
					set: (r, i, l) => {
						r.call(
							i,
							e.rewriteCSS(l, { context: "value", ...e.meta }),
						);
					},
				});
		else
		...
		a.style.on("setCssText", (t) => {
			...
			a.location.on("hashchange", (t, r, i) => {
				if (i.HashChangeEvent && a.history.replaceState) {
					a.history.replaceState.call(
						o.history,
						"",
						"",
						e.rewriteUrl(r),
					);
					let l = new i.HashChangeEvent("hashchange", {
						newURL: r,
						oldURL: t,
					});
					...
					value: function (t) {
						return a.nativeMethods.isExtensible(this)
							? (a.nativeMethods.defineProperty(
									this,
									e.methods.source,
									{ value: t, writable: !0, enumerable: !1 },
								),
								this)
							: this;
					},
			...
			a.nativeMethods.defineProperty(
				o.Object.prototype,
				e.methods.source,
				{ value: e, writable: !0, enumerable: !1 },
			),
			a.nativeMethods.defineProperty(
				o.Object.prototype,
				e.methods.location,
