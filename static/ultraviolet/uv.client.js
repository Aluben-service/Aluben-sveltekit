			...
			if (e === r || e.listener === r)
				...
				i === 0 ? e.shift() : Fe(e, i),
					...
					n.removeListener !== void 0 &&
						this.emit("removeListener", t, l || r);
			}
			return this;
		};
			...
			overrideNameValue() {
				this.ctx.overrideDescriptor(this.attrProto, "name", {
					...
					this.ctx.overrideDescriptor(this.attrProto, "value", {
						...
						set: (t, r, [e]) => {
							let n = new s(
								{ name: this.name.get.call(r), value: e },
								t,
								r,
							);
			...
			emulate(t, r) {
				...
				return (
					"reload" in this.location &&
						this.ctx.nativeMethods.defineProperty(e, "reload", {
							value: this.ctx.wrap(
								this.location,
								"reload",
								(i, o) => i.call(o === e ? this.location : o),
							),
							writable: !1,
							enumerable: !0,
						}),
					...
					this.ctx.nativeMethods.defineProperty(
						e,
						Symbol.toPrimitive,
						{ value: () => e.href, writable: !1, enumerable: !1 },
					),
