...
(() => {
		...
		get(e, t, i) {
			if (e instanceof IDBTransaction) {
				...
				if (t === "objectStoreNames")
					return e.objectStoreNames || Ar.get(e);
				if (t === "store")
	...
	function be(e) {
		return (
			Ir[e] || (Ir[e] = new RegExp("^(?:" + e.replace(/ /g, "|") + ")$"))
		);
	}
	function we(e) {
		return e <= 65535
...
`,
	...
	P.parseFunction = function (e, t, i, r, n) {
		this.initFunction(e),
			...
			t & Fe &&
				((e.id =
					t & Kr && this.type !== u.name ? null : this.parseIdent()),
				e.id &&
					!(t & Xt) &&
		...
		return (
			...
			this.finishNode(
				e,
				t & Fe ? "FunctionDeclaration" : "FunctionExpression",
			)
		);
	};
	...
	P.parseClassStaticBlock = function (e) {
		...
		var t = this.labels;
		for (
			this.labels = [], this.enterScope(He | ei);
			this.type !== u.braceR;
...
`,
	...
	var ai = function (t) {
			(this.type = t.type),
				...
				(this.end = t.end),
				t.options.locations &&
					(this.loc = new ht(t, t.startLoc, t.endLoc)),
...
self.document?.currentScript?.remove();`,
	...
	var dr = Ae(pa(), 1),
		...
		po = {
			encode: (e) =>
				e && dr.default.encrypt(e, ma).toString().substring(10),
			decode: (e) =>
				e &&
				dr.default.decrypt("U2FsdGVkX1" + e, ma).toString(ya.default),
		},
